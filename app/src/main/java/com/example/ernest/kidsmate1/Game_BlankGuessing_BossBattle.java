...
public class Game_BlankGuessing_BossBattle extends Game_BlankGuessing {
    ...
    protected void endingSession(){
        ...
        int tempInt = mDatabaseStateManager.getUserBG_count();
        mDatabaseStateManager.addUserBG_count(-tempInt); // // TODO: 2017-05-09  게임 플레이 카운트를 초기화하는 방식으로 대응하고 있지만, 게임 플레이 카운트가 누적되도록 변경해야 함.
        showTotalResult();
    }
