...
/**
 * Continuously records audio and notifies the {@link APITEST_VoiceRecorder.Callback} when voice (or any
 * sound) is heard.
 *
 ...
 */
public class APITEST_VoiceRecorder {
    ...
    public APITEST_VoiceRecorder(@NonNull Callback callback) {
        mCallback = callback;
    }
