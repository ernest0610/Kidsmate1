...
public class Game_BlankGuessing_TestView extends AppCompatActivity {
    // 디버깅 메시지
    protected static final String TAG = Game_BlankGuessing_TestView.class.getSimpleName();
    ...
    protected void endingSession(){
        ...
        mDatabaseStateManager.addUserBG_count(1);
        showTotalResult();
    }
    ...
    protected void sendResultToDatabase(){
        ...
        mDatabaseStateManager.addCharacterLuck(session_admin.getCorrectRound());
    }
    ...
    protected void showTotalResult(){
        ...
        game_result.setOnCancelListener(new DialogInterface.OnCancelListener(){
            ...
            public void onCancel(DialogInterface dialog){
                Game_BlankGuessing_TestView.this.finish();
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCharacter.setImage(R.drawable.sunggisa);
        enemy.setImage(R.drawable.blankenemy);
        ...
        gameView.setBackgroundResource(R.drawable.blankgamebackground);
    ...
    protected static class InnerEventHandler extends Handler {
        // 이벤트 핸들러 이너 클래스
        private final WeakReference<Game_BlankGuessing_TestView> mActivity;
        InnerEventHandler(Game_BlankGuessing_TestView activity) {
            mActivity = new WeakReference(activity);
        }
        @Override
        public void handleMessage(Message msg) {
            Game_BlankGuessing_TestView activity = mActivity.get();
            if (activity != null) {
